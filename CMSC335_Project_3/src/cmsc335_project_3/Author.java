//Author.java,  29 September 2014, Benjamin Knauth, Class Author for CMSC335 Project 3.
...
public class Author{
    ...
    LinkedHashMap<Integer, Journal> Journals = new LinkedHashMap<Integer,Journal>();//Holds objects of type Journals.
